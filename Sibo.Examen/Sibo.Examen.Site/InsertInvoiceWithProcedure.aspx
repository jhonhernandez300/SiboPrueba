<%@ Page Title="" Language="C#" MasterPageFile="~/examen.Master" AutoEventWireup="true" CodeBehind="InsertInvoiceWithProcedure.aspx.cs" Inherits="Sibo.Examen.Site.InsertInvoiceWithProcedure" %>
...
&nbsp;
        ...
        <br />
        <br />&nbsp;<asp:Button ID="butBuscar" runat="server" Text="Buscar" OnClick="butBuscar2_Click" />
        <br />
        <br />&nbsp;<asp:Button ID="butAgregarProducto" runat="server" Text="Agregar Producto" OnClick="butAgregarProducto_Click" />
    </div>
    <br />Productos Seleccionados&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;<br />
