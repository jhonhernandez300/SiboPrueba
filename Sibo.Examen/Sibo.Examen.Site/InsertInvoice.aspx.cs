...
{
    public partial class InsertInvoice2 : System.Web.UI.Page
    {   
        ...
        protected void butIngresarVenta_Click(object sender, EventArgs e)
        {
            ...
            var inserted = invoiceBLL.Post(invoice);
            ...
            if (inserted != null)
            {
                for (int i = 0; i <= lisProductsIDs.Items.Count - 1; i++)
                {
                    ...
                    invoiceDetail.InvoiceID = inserted.InvoiceID;
                    ...
                    InvoiceDetailBLL invoiceDetailDLL = new InvoiceDetailBLL();
                    var detailInserted = invoiceDetailDLL.Post(invoiceDetail);

                    ProductBLL productBLL = new ProductBLL();
                    var updated = productBLL.Put(Convert.ToInt32(lisProductsIDs.Items[i].Value), Convert.ToInt32(texCantidadAVender.Text));

                    if (updated != null && detailInserted != null)
                    {
